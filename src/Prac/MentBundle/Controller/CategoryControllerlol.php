 ...
 *
 */
class CategoryControllerlol extends Controller
{
    /**
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('prac_ment_show', array('id' => $category->getId()));
        }
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('prac_ment_edit', array('id' => $category->getId()));
        }
    ...
    private function createDeleteForm(Category $category)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('prac_ment_delete', array('id' => $category->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
