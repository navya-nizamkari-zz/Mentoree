...
use Prac\MentBundle\Form\SkillType;

/**
 * Skill controller.
 *
 */
class SkillControllerlol extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $skills = $em->getRepository('MentBundle:Skill')->findAll();
    ...
    {
        $skill = new Skill();
        $form = $this->createForm('Prac\MentBundle\Form\SkillType', $skill);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('prac_ment_show', array('id' => $skill->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($skill);
        $editForm = $this->createForm('Prac\MentBundle\Form\SkillType', $skill);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('prac_ment_edit', array('id' => $skill->getId()));
        }
    ...
    private function createDeleteForm(Skill $skill)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('prac_ment_delete', array('id' => $skill->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
